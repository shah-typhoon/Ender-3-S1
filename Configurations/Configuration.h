...
#define STRING_CONFIG_H_AUTHOR "(shah-typhoon, Ender 3 S1 F4)" // Who made the changes.
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -31.75, -40.85, -0 }
 ...
 * Useful for a strain gauge or piezo sensor that needs to factor out * elements such as cables pulling on the carriage.
 */
//#define PROBE_TARE
